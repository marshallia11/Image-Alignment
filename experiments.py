...
if __name__ == '__main__':
    original ='/home/kuro/project/Image-Alignment/input/1_2.png'
    wrap ='/home/kuro/project/Image-Alignment/input/1_11.png'
    img_ori = io.imread(original)
    img_warped = io.imread(wrap)

    img_orig = rescale_intensity(img_ori)
